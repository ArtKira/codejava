...
public class Practicaredes {
   ...
   //metodo FALTAS 
   public static double descuentoFaltas(double sueldoBase) throws IOException{
       int faltas;
    ...
    public static void main(String[] args) throws IOException {
     ...
     //   char antiguedad;
        ...
        do{
            ...
            descuentoPorFaltas=descuentoFaltas(sueldoBase);
